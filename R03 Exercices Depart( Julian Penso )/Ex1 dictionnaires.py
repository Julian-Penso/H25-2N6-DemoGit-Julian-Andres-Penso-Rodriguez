...
print(f"Q1 Le nom de l'étudiant est : {etudiant.get('nom')}")
...
courriel_ajout = {'courriel' :'2112344@cegepmontpetit.ca' }
etudiant.update(courriel_ajout)
print(f"Voici le courriel de l'étudiant qui a été ajouté: {etudiant.get('courriel')}")
...
courriel_update = {'courriel' :'2000000@cegepmontpetit.ca' }
etudiant.update(courriel_update)
print(f"Voici le nouveau courriel de l'étudiant: {etudiant.get('courriel')}")
...
valeur_retirée = etudiant.pop('age')
print(f"on a enlevé l'âge de l'étudiant, sa valeur était: 17")
